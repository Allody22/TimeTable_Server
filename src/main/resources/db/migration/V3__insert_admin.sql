...
-- пароль admin
VALUES (CURRENT_TIMESTAMP, 'admin@gmail.com', '1234567890', 'Admin User', '$2a$10$YrLOEZ78QgwmyLcYF/M9y.4/kGU9djHyfLv7n8fCA.Cp1Of3Aatka');
...
$$
    ...
    BEGIN
        ...
        SELECT last_user_id, id FROM roles
